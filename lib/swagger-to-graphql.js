    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < swaggerPaths.length; i++) {
            const schema = yield swagger_to_graphql_1.default({
                swaggerSchema: utils_1.checkUrlForm(swaggerPaths[i]) ? swaggerPaths[i] : path_1.default.join(rootDir, swaggerPaths[i]),
                callBackend
            });
            yield fs_1.default.writeFileSync(path_1.default.join(rootDir, schemaOutputFiles[i]), graphql_1.printSchema(schema));
            console.log(`GraphQL Schema file (${path_1.default.join(rootDir, schemaOutputFiles[i])}) was generated!`);
            schemas.push(schema);
        }
        return schemas;
    });
