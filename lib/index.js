...
function cli() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield graphql_code_generator_1.createTypesFromSchema(schemas, typesOutputFiles);
        yield apollo_datasource_rest_1.createRESTDataSource(swaggerPaths, typesOutputFiles, restDataSourceOutputFiles);
        yield apollo_datasource_rest_1.createResolvers(swaggerPaths, typesOutputFiles, restDataSourceOutputFiles, resolversOutputFiles);
    });
}
exports.cli = cli;
