...
function createTypesFromSchema(schemas, typesOutputFiles) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < schemas.length; i++) {
            ...
            yield fs_1.default.writeFileSync(path_1.default.join(rootDir, typesOutputFiles[i]), output);
            console.log(`Type Definition file (${path_1.default.join(rootDir, typesOutputFiles[i])}) was generated!`);
        }
    });
}
